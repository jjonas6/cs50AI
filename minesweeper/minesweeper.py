...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        # add new sentences based on new information
        if len(self.knowledge) >= 2:
            for sentence1, sentence2 in itertools.permutations(self.knowledge.copy(), 2):
            ...
            for sentence in self.knowledge:
                for nearby_cell in sentence.cells.copy():
                    if nearby_cell in self.safes:
                        sentence.cells.remove(nearby_cell)
